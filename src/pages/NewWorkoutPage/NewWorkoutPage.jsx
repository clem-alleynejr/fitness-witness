...
export default function NewWorkoutPage({
  ...
  async function handleAddToWorkout(exerciseId) {
    const updatedUnsavedWorkout = await workoutsAPI.addExerciseToUnsavedWorkout(
      exerciseId
    );
  ...
  return (
    <main className="NewWorkoutPage">
      ...
      <ExerciseOptionList
        exerciseOptions={exerciseOptions.filter(
          (exercise) => exercise.bodyPart === activeBodyPart
        )}
